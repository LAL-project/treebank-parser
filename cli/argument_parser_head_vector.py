...
def add_arguments_head_vector_parser(parser):
	...
	parser.add_argument(
		'--' + head_vector_action_type.DiscardSentencesShorter_key_str,
		default = -1,
		type = int,
		metavar = "length_in_words",
		required = False,
		help = head_vector_action_type.DiscardSentencesShorter_help_str
	)
	
	# discard short sentences
	parser.add_argument(
		'--' + head_vector_action_type.DiscardSentencesLonger_key_str,
		default = -1,
		type = int,
		metavar = "length_in_words",
		required = False,
		help = head_vector_action_type.DiscardSentencesLonger_help_str
	)
	
	# chunk tree
	parser.add_argument(
		'--' + head_vector_action_type.ChunkTree_key_str,
		required = False,
		type = str,
		choices = head_vector_action_type.ChunkTree_choice_list,
		help = head_vector_action_type.ChunkTree_help_str,
